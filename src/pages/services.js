               ...
               <div style={TitleContentStyles}>
                  ...
                  <h5 style={ApproachDescriptionTextStyles}>
                     <ul>
                        ...
                        <li>Preparation session | $100-$150 one hour</li>
                        <li>Lozenge KAP session | $200-$300 two hours</li>
                        <li>Lozenge KAP session | $300-$450 three hours</li>
                        <li>Integration session | $100-$150 one hour</li>
                        <li>Individual Psychotherapy | $100-$150 one hour</li>
                     </ul>
                  </h5>
               </div>
            </div>
