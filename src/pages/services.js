         ...
         <div style={contentContainer}>
            ...
            <div style={primaryContentStyles}>
               <div style={TitleContentStyles}>
                  ...
                  <h5 style={ApproachDescriptionTextStyles}>
                  <ul>
                        <li> Using cognitive-behavior therapy you will learn to increase your awareness and attention to patterns of thinking and behaving that are causing you problems in your life. By developing helpful skills to change your thinking and behaviors you can learn to have a more relaxed, creative, and flexible mind. Different skills that can be learned are progressive muscle relaxation, cognitive reframing, social skills, problem solving skills, and mindfulness based exercises to become more present in the moment and quiet down your anxious thoughts.   </li>
                        <li> I provide individual psychotherapy for chemical addictions, anxiety disorders, depressive disorders, and general problems in your daily life that are causing you distress. </li>
                     </ul>
                  </h5>
                  <br />
                  ...
                  <h5 style={ApproachDescriptionTextStyles}>
                     <ul>
                        ...
                        <li>Individual Psychotherapy | $150 one hour</li>
                     </ul>
                  </h5>
               </div>
            </div>
